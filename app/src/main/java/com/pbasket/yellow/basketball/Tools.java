...
public class Tools {
    ...
    public static void setBasket(String newLink, Activity context) {
        Basketdata basketdata = new Basketdata(context);
        basketdata.setBasket("http://" + cut(newLink));
    ...
    public void showBasketPolicy(Context context, String link){
